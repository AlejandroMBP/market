                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-3 text-right text-sm">
                                            <div class="flex justify-end gap-3">
                                                <a href="{{ route('roles.show', $role) }}" class="text-indigo-600 hover:text-indigo-900">Ver</a>
                                                @can('roles.editar')
                                                    <a href="{{ route('roles.edit', $role) }}" class="text-yellow-600 hover:text-yellow-900">Editar</a>
                                                @endcan
                                                @can('roles.eliminar')
